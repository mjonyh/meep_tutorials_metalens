...
| F10 | 1013-1071 global | `Using MPI version 3.1, 1 processes` per rank (4x serial replicas) | `srun -n 4` launches independent serial MEEP instances; no domain decomposition | Root cause: missing PMI launcher wiring. Fixed by `srun --mpi=pmix -n 4` (Job 1090/1092+). Scaling measured CO1 (Jobs 1171-1173) | Superseded by F13 (Closed) |
